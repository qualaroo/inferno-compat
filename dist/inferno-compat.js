(function (global, factory) {
    ...
    (global = global || self, factory(global.Inferno = global.Inferno || {}, global.Inferno, global.Inferno, global.Inferno, global.Inferno, global.Inferno));
        ...
        if (childFlags !== 1 /* HasInvalidChildren */) {
            if (childFlags === 2 /* HasVNodeChildren */) {
                if (isNull(currentNode)) {
                    inferno._M(children, parentNode, context, isSVG, null, lifecycle, doc);
                }
                else {
                ...
                for (var i = 0, len = children.length; i < len; ++i) {
                    ...
                    if (isNull(currentNode) || (prevVNodeIsTextNode && (child.flags & 16 /* Text */) > 0)) {
                        inferno._M(child, parentNode, context, isSVG, currentNode, lifecycle, doc);
                    }
                    else {
    ...
    function hydrateElement(vNode, parentDOM, dom, context, isSVG, lifecycle, doc) {
        ...
        if (dom.nodeType !== 1 || dom.tagName.toLowerCase() !== vNode.type) {
            inferno._ME(vNode, null, context, isSVG, null, lifecycle, doc);
            ...
            if (!isNull(props)) {
                inferno._MP(vNode, flags, props, dom, isSVG, doc);
            }
    ...
    function hydrateText(vNode, parentDOM, dom, doc) {
        if (dom.nodeType !== 3) {
            inferno._MT(vNode, null, null, doc);
            parentDOM.replaceChild(vNode.dom, dom);
        }
        else {
