...
declare function render(rootInput: any, container: any, cb?: null, context?: {}): any;
export { Children, ClassicComponentClass, Component, ComponentSpec, ComponentType, EMPTY_OBJ, Fragment, InfernoNode, Props, PropTypes, PureComponent, Refs, VNode, _CI, _HI, _M, _MCCC, _ME, _MFCC, _MP, _MR, _MT, __render, cloneVNode as cloneElement, cloneVNode, createClass, createComponentVNode, createElement, createFactory, createFragment, createPortal, createRef, createRenderer, createTextVNode, createVNode, directClone, findDOMNode, findDOMfromVNode, forwardRef, getFlagsForElementVnode, hydrate, isValidElement, linkEvent, normalizeProps, options, render, rerender, unmountComponentAtNode, unstable_renderSubtreeIntoContainer, version };
declare const _default: {
    ...
    options: {
        ...
        renderComplete: ((rootInput: string | number | boolean | {} | VNode | InfernoElement<any> | import("../../inferno/src").InfernoNodeArray | JSX.Element | null, parentDOM: Element | Node | SVGAElement | DocumentFragment | ShadowRoot | HTMLElement) => void) | null;
